...
public class IDshellsApiTest {
    ...
    public static String authServerAddr = "http://140.143.204.240:1880"; // 应用服务器访问地址
    public static String appKey = "08AA92FD3CC3E11A12DD"; // 应用标识
    public static String appSecret = "CDFF0E48D1090209634C00297489D7ED7C1118F8"; // 应用安全密钥
    ...
    public static void init(String userName){
        IDshellsApi.init(authServerAddr, appKey, appSecret);// 初始化
        IDshellsApiTest.userName = userName;
    }
    public static void send(String phoneSN){
        String userName = "test-user";
        sendSmsOtp(userName,phoneSN);
    }
    ...
    public static void main(String[] args) {
        ...
        sendSmsOtp(userName,"13000000000");
